...
name = "XXX_CHR1_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR1_combine_Yfit1.dat"
file = open(name,"rb") 
...
name = "XXX_CHR2_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR2_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()
...
name = "XXX_CHR3_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR3_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()

#############################
name = "XXX_CHR4_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR4_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()

#############################
name = "XXX_CHR5_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR5_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()

#############################
name = "XXX_CHR6_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR6_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()

#############################
name = "XXX_CHR7_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR7_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()

#############################
name = "XXX_CHR8_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR8_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()

#############################
name = "XXX_CHR9_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR9_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()

#############################
name = "XXX_CHR10_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR10_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()

#############################
name = "XXX_CHR11_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR11_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()

#############################
name = "XXX_CHR12_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR12_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()

#############################
name = "XXX_CHR13_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR13_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()

#############################
name = "XXX_CHR14_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR14_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()

#############################
name = "XXX_CHR15_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR15_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()

#############################
name = "XXX_CHR16_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR16_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()

#############################
name = "XXX_CHR17_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR17_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()

#############################
name = "XXX_CHR18_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR18_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()

#############################
name = "XXX_CHR19_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR19_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()

#############################
name = "XXX_CHR20_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR20_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()

#############################
name = "XXX_CHR21_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR21_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()

#############################
name = "XXX_CHR22_combine_Xfit1.dat"
file = open(name,"rb") 
Xfit1_list.append( pickle.load(file) )
file.close()

name = "XXX_CHR22_combine_Yfit1.dat"
file = open(name,"rb") 
Yfit1_list.append( pickle.load(file) )
file.close()
...
name = "XXX_combine_Ntlist_approach12.dat"
file = open(name,"wb") 
pickle.dump(Ntlist,file)
file.close()

name = "XXX_combine_investlist__approach12.dat"
file = open(name,"wb") 
