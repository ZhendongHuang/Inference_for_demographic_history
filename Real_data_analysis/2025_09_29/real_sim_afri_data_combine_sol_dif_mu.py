...
name = "Simulation_CHR1_combine_Xfit1_dif_mu.dat"
file = open(name,"rb") 
Xfit1=  pickle.load(file) 
file.close()

name = "Simulation_CHR1_combine_Yfit1_dif_mu.dat"
file = open(name,"rb") 
...
for i in range(22):
    ...
    name = "Simulation_CHR"+str(i+1)+"_combine_Xfit1_dif_mu.dat"
    file = open(name,"rb") 
    Xfit1=pickle.load(file) 
    file.close()

    name = "Simulation_CHR"+str(i+1)+"_combine_Yfit1_dif_mu.dat"
    file = open(name,"rb") 
    Yfit1 =pickle.load(file) 
    file.close()
...
name = "Simulation_afri_combine_dif_mu_Ntlist_approach12.dat"
file = open(name,"wb") 
pickle.dump(Ntlist,file)
file.close()

name = "Simulation_afri_combine_dif_mu_investlist__approach12.dat"
file = open(name,"wb") 
