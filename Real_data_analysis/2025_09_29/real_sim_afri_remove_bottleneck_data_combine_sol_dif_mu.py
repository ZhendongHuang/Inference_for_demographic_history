...
name = "Simulation_add_bottleneck_CHR1_combine_Xfit1_dif_mu.dat"
file = open(name,"rb") 
Xfit1=  pickle.load(file) 
file.close()

name = "Simulation_add_bottleneck_CHR1_combine_Yfit1_dif_mu.dat"
file = open(name,"rb") 
Yfit1 = pickle.load(file)  
file.close()

# #############################


d = Xfit1.shape[1]  # feature dimension
m = Yfit1.shape[1] if Yfit1.ndim > 1 else 1
...
for i in range(22):
    ...
    name = "Simulation_add_bottleneck_CHR"+str(i+1)+"_combine_Xfit1_dif_mu.dat"
    file = open(name,"rb") 
    Xfit1=pickle.load(file) 
    file.close()

    name = "Simulation_add_bottleneck_CHR"+str(i+1)+"_combine_Yfit1_dif_mu.dat"
    file = open(name,"rb") 
    Yfit1 =pickle.load(file) 
    file.close()

    A += Xfit1.T @ Xfit1
    Yfit1 = Yfit1.reshape(-1,1)
    b += Xfit1.T @ Yfit1
...
name = "Simulation_afri_remove_bottleneck_combine_dif_mu_Ntlist_approach12.dat"
file = open(name,"wb") 
pickle.dump(Ntlist,file)
file.close()

name = "Simulation_afri_remove_bottleneck_combine_dif_mu_investlist__approach12.dat"
file = open(name,"wb") 
...
print("Completed (Simulation_combine)")
