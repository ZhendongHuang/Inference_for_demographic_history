...
# ====== 4. Simplify and Save ======
mts1 = tskit.load("mts_chr??_XXX.trees")


print("Load data complete (XXX_combine_Chr??)")
...
# name = "XXX_combine_mts1_approach12.dat"
# file = open(name,"rb") 
...
print("Sim_tree_completed (XXX_combine)",'CHR: ','chrom:')
...
name = "XXX_CHR??_combine_Xfit1_dif_mu.dat"
file = open(name,"wb") 
pickle.dump(Xfit1,file)
file.close()

name = "XXX_CHR??_combine_Yfit1_dif_mu.dat"
file = open(name,"wb") 
...
print("Completed (XXX_combine_Chr??)")
