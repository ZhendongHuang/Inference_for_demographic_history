...
do
  ...
  cp real_data_combine_x1y1_dif_mu.py ${POP}_chr${CHROM}_combine_x1y1_dif_mu.py
  sed -i "s/XXX/${POP}/g" ${POP}_chr${CHROM}_combine_x1y1_dif_mu.py
  sed -i "s/??/${CHROM}/g" ${POP}_chr${CHROM}_combine_x1y1_dif_mu.py
  python3 ${POP}_chr${CHROM}_combine_x1y1_dif_mu.py
done

cp real_data_combine_sol_dif_mu.py ${POP}_real_data_combine_sol_dif_mu.py
sed -i "s/XXX/${POP}/g" ${POP}_real_data_combine_sol_dif_mu.py
# sed -i "s/??/${CHROM}/g" ${POP}_real_data_combine_sol_dif_mu.py
python3 ${POP}_real_data_combine_sol_dif_mu.py
