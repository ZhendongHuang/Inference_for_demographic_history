...
Ntlist[0] = numpy.array(Ntlist[0])
Ntlist[0][ [54,56,58,60,62,64,66,68,70,72,74,76,78,80,82,84,86] ] = numpy.linspace(50000, 40000, 17)
Ntlist[0][ [55,57,59,61,63,65,67,69,71,73,75,77,79,81,83,85,87] ] = numpy.linspace(50000, 40000, 17)
...
name = "Simulation_add_bottleneck_CHR??_combine_Xfit1_dif_mu.dat"
file = open(name,"wb") 
pickle.dump(Xfit1,file)
file.close()

name = "Simulation_add_bottleneck_CHR??_combine_Yfit1_dif_mu.dat"
file = open(name,"wb") 
