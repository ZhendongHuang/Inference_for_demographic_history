...
pop_ini_size = 20000
demo_model = msprime.Demography.isolated_model([pop_ini_size], growth_rate=[10**(-4)])
...
#     plt.plot(invest,Nt)
#     xxx = numpy.linspace(0,80000,200)
#     yyy3 = 2*pop_ini_size*numpy.exp(-0.0001*xxx)*(xxx<30000) + 2*pop_ini_size*numpy.exp(-0.0001*30000)*(xxx>=30000)
#     #plt.plot(xxx,yyy1,'k')
#     #plt.plot(xxx,yyy2,'k')
#     #plt.ylim(0,10000)
#     plt.plot(xxx,yyy3,'k')
...
name = "Model2_rcon2_sam100_ave_time_approach12.dat"
file = open(name,"wb") 
pickle.dump(ave_time,file)
file.close()   
    
    
name = "Model2_rcon2_sam100_Ntlist_approach12.dat"
file = open(name,"wb") 
pickle.dump(Ntlist,file)
file.close()

name = "Model2_rcon2_sam100_investlist__approach12.dat"
file = open(name,"wb") 
pickle.dump(investlist,file)
file.close()

name = "Model2_rcon2_sam100_lambda__approach12.dat"
file = open(name,"wb") 
