...
name = "Model3_sam10_ave_time_approach12.dat"
file = open(name,"wb") 
pickle.dump(ave_time,file)
file.close()   
    
    
name = "Model3_sam10_Ntlist_approach12.dat"
file = open(name,"wb") 
pickle.dump(Ntlist,file)
file.close()

name = "Model3_sam10_investlist__approach12.dat"
file = open(name,"wb") 
pickle.dump(investlist,file)
file.close()

name = "Model3_sam10_lambda__approach12.dat"
file = open(name,"wb") 
