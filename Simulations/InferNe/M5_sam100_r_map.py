...
name = "Model5_sam100_ave_time_approach12.dat"
file = open(name,"wb") 
pickle.dump(ave_time,file)
file.close()   
    
name = "Model5_sam100_Ntlist_approach12.dat"
file = open(name,"wb") 
pickle.dump(Ntlist,file)
file.close()

name = "Model5_sam100_investlist__approach12.dat"
file = open(name,"wb") 
pickle.dump(investlist,file)
file.close()

name = "Model5_sam100_lambda__approach12.dat"
file = open(name,"wb") 
