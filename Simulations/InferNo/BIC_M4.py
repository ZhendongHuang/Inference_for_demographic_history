...
pop_ini_size = 20000
demo_model = msprime.Demography.isolated_model([pop_ini_size], growth_rate=[0.0002])
demo_model.add_population_parameters_change(3000,  initial_size=None, growth_rate= 0.0001, population=None)
demo_model.add_population_parameters_change(9000,  initial_size=None, growth_rate= -0.00003, population=None)
demo_model.add_population_parameters_change(18000,  initial_size=None, growth_rate=-0.00003, population=None)
...
name = "Model4_bic_bic_lam="+str(current_lambda2) + "_approach12.dat"
file = open(name,"wb") 
pickle.dump(bic_list,file)
file.close()   
    
name = "Model4_bic_Ntlist_lam="+str(current_lambda2) + "_approach12.dat"
file = open(name,"wb") 
pickle.dump(Ntlist,file)
file.close()

name = "Model4_bic_investlist_lam="+str(current_lambda2) + "_approach12.dat"
file = open(name,"wb") 
