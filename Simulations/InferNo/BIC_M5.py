...
pop_ini_size = 20000
demo_model = msprime.Demography.isolated_model([pop_ini_size], growth_rate=[0])
...
name = "Model5_bic_bic_lam="+str(current_lambda2) + "_approach12.dat"
file = open(name,"wb") 
pickle.dump(bic_list,file)
file.close()   
    
name = "Model5_bic_Ntlist_lam="+str(current_lambda2) + "_approach12.dat"
file = open(name,"wb") 
pickle.dump(Ntlist,file)
file.close()

name = "Model5_bic_investlist_lam="+str(current_lambda2) + "_approach12.dat"
file = open(name,"wb") 
